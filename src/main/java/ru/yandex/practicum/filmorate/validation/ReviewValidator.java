...
public class ReviewValidator {
    ...
    public void forCreate(Review review) {
        if (Objects.isNull(review.getUserId())) throw new ValidationException("некорректный id пользователя.");
        if (Objects.isNull(review.getFilmId())) throw new ValidationException("некорректный id фильма.");
